...
public class Contract {
    ...
    public Contract( Date contract_start_date, Date contract_end_date, double contract_deposit, int employee_id, int customer_id, int service_id) {
    ...
    public Contract(int contract_id, Date contract_start_date, Date contract_end_date, double contract_deposit, int employee_id, int customer_id, int service_id) {
