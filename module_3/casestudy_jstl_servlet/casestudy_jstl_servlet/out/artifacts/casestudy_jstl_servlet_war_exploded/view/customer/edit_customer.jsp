...
<%--Bạn đã cập nhật thành công--%>
            ...
            <div class="form-group">
                <label for="numberId">ID Type Customer</label>
                <input type="number" class="form-control" id="numberTypeId" name="customer_type_id" aria-describedby="numberTypeId" readonly value="${customer.customer_type_id}">
